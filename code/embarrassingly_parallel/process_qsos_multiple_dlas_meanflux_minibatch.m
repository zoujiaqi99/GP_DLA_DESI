...
variables_to_load = {'wavelengths', 'flux', 'noise_variance'};
load(preload_path, ...
     variables_to_load{:});
...
all_wavelengths    =    wavelengths(test_ind);
all_flux           =           flux(test_ind);
all_noise_variance = noise_variance(test_ind);
...
% save results
variables_to_save = {'training_release', ...
                      'prior_ind',  ...
                      'prior_z_qso_increase', 'k', ...
